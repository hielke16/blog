...
class Text extends AbstractMetabox
{    
    /**
    ...
    ?>
        <input type="text" name="<?php echo $this->getName($this->options['name']) ?>" value="<?php echo esc_attr($value)?>" class="<?php echo $this->options['class'] ?>" />
