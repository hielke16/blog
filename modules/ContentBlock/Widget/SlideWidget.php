...
class SlideWidget extends AbstractImageWidget
{
    public function __construct()
    {
        $options = array('classname' => 'widget-featured-contentblock', 'description' => 'Een zelf te beheren content blok met uitgelichte afbeelding.');
        parent::__construct('featured-contentblock', 'Uitgelicht ContentBlock', $options);
    ...
    public function widget($args, $instance)
    {
        ...
        // $post = get_post($instance['block_id']);
        if (!empty($instance['classname'])) {
            $args['before_widget'] = preg_replace('#class="#', 'class="' . $instance['classname'] . ' ', $args['before_widget'], 1);
        }
        if($args['container'] != null){
            // echo $args['before_widget'];
            echo $view->partial('partials/widgets/featured-contentblock.phtml', array_merge($args, $instance, array( 'url' => $this->getUrl($instance), 'title' => nl2br($instance['title']))));
    ...
    ?>
        ...
        <p><label>Content <small style="float: right; font-weight: bold;">(optioneel)</small><br />
            <?php echo $view->formTextarea(
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        $instance['content']     = (isset($new_instance['title'])) ? strip_tags($new_instance['title']) : null;
    ...
    public function enqueueScripts($hook)
    {
        ...
        wp_enqueue_script('jquery.widget-contentblock', get_bloginfo('stylesheet_directory') . '/assets/lib/js/admin/jquery.widget-contentblock.js', array('jquery'), false, true);
