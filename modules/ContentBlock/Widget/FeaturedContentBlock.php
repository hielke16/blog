...
class FeaturedContentBlock extends AbstractImageWidget
{
    ...
    public function widget($args, $instance)
    {
        ...
        if (!empty($instance['classname'])) {
            ...
            echo $view->partial('partials/widgets/featured-contentblock.phtml', array_merge($args, $instance, array('post' => $post, 'url' => $this->getUrl($instance), 'title' => nl2br($instance['title']))));
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        $instance['block_id']  = (isset($new_instance['block_id']) && is_numeric($new_instance['block_id'])) ? (int) $new_instance['block_id'] : null;
